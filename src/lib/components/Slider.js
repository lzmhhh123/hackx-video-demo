...
const propTypes = {
  ...
  getPercentByArg: PropTypes.func,
...
export default class Slider extends Component {
  ...
  render() {
    const { vertical, label, valuenow, valuetext, getPercentByArg, getPercent } = this.props;
    //console.log("getPercent", getPercent);
    //console.log("getPercentByArg",getPercentByArg);
    //const test = getPercentByArg(30);
